...
class Tests {
    ...
    @Test
    void discount_studentAndBlackFriday_appliedCorrectly() {
        DiscountService service = new DiscountService();
        assertEquals(90.0, service.applyDiscount(100, "STUDENT10"));
        assertEquals(70.0, service.applyDiscount(100, "BLACKFRIDAY"));
    }
    ...
    @Test
    void pricing_zeroSubtotal_returnsZeroTax() {
        PricingService service = new PricingService();
    ...
    @Test
    void orderService_validPayment_processesOrder() {
        Order order = new Order();
        order.addItem(new OrderItem("Item", 1, 100));
        ...
        assertEquals(108.0, result); // 100 -> 90 + 20% tax
    }
}